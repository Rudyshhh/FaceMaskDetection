...
from tensorflow.keras.applications import MobileNetV2 #Instantiates the MobileNetV2 architecture.
from tensorflow.keras.layers import AveragePooling2D #Building a new fully-connected (FC) head
...
from tensorflow.keras.preprocessing.image import load_img #Loading image data
from tensorflow.keras.utils import to_categorical
from sklearn.preprocessing import LabelBinarizer
from sklearn.model_selection import train_test_split
from sklearn.metrics import classification_report
from imutils import paths #find and list images in our dataset
...
for imagePath in imagePaths:
    ...
    image = load_img(imagePath, target_size=(224, 224)) #Loads an image into PIL(Python Imaging Library-now Pillow) format for loading and manipulating images.
